...
_STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "app_tagline": "Generate original JLPT-style questions (Reading) and get a strengths/weaknesses summary.",
        "language": "Language",
        "section": "Section",
        "level": "Level",
        "category": "Category",
    ...
    "ja": {
        ...
        "app_tagline": "オリジナルのJLPT形式問題（読解）を出題し、最後に強み・弱点のフィードバックを表示します。",
        "language": "言語",
        "section": "セクション",
        "level": "レベル",
        "category": "カテゴリ",
    ...
    "zh_TW": {
        ...
        "app_tagline": "產生原創 JLPT 風格題目（讀解），完成後提供強弱項回饋摘要。",
        "language": "介面語言",
        "section": "類型",
        "level": "級別",
        "category": "類別",
